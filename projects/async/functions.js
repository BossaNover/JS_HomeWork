...
function loadAndSortTowns() {
  ...
  //localeCompare -- сравнивает города (a.name - первый город, b.name - второй)
  //localeCompare -- возвращает -1, если первая строка должна быть выше, чем вторая, или 0 или +1.
}
